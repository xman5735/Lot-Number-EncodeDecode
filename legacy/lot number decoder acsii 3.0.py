...
#shoudl be updated to modular style
def getColor(color):
...
#break tuple 'splits' into integers
    ...
    print('')
    print('The boards were made on the month: ', dateNum[0:2], ' of the year 20', dateNum[-2:])
    print('Exact day created will be on label and records')
    print('')
