...
def getBoardSize():
    ...
    while i == 0:
        ...
        print(r"""
            1. 1/2          4. 1 1/8        7. 3 1/2
            2. 3/4          5. 1 1/2
            3. 1            6. 2 1/2
            """)
        boardFirstDim = input('Select the first dimension by typing 1-7: ')
        boardFirstDim = int(boardFirstDim)
        if boardFirstDim >= 8:
            boardFirstDim = 100
        boardFirstDim = str(boardFirstDim)
        
        print(r"""
            1. 1 1/2        4. 2 5/8        7. 8
            2. 1 3/4        5. 3 1/2        8. 9 1/2
            3. 2 1/2        6. 5 1/2
            """)
        boardSecondDim = input('Select second dimension by typing 1-8: ')
        boardSecondDim = int(boardSecondDim)
        if boardSecondDim >= 9:
            boardSecondDim = 100
        boardSecondDim = str(boardSecondDim)
        boardSize = boardFirstDim + boardSecondDim
