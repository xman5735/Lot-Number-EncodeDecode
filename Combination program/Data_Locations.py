...
def check_color_standard_range(lot_avg_L, lot_avg_a, lot_avg_b, colorOut):
    ...
    file_path = r"C:\Users\alex\Desktop\Files\Standards\S-001 Colorimeter Profile Standard.xlsx"
...
def check_profile_standard_range(profile_width, profile_edge, profile_middle, profile_med, boardOut):
    ...
    file_path = r"C:\Users\alex\Desktop\Files\Standards\S-004 Profile Thickness Δ Standard.xlsx"
    df = openpyxl.load_workbook(file_path)
    sheet = df.active
...
def format_excel(format_excel_tuple):
    ...
    folder_path_create = 'Files\\Data\\Reports\\' + 'Line ' + line_num + '\\' + profile.replace("/", "-") + '\\' + color + '\\'
